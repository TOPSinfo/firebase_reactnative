    ...
    return (
        <View style={{ height: defaultHeight + 10 }}>
            ...
            <View style={styles.container}>
                <TouchableOpacity onPress={onBack} style={{ width: '10%', justifyContent: 'center' }}>
                    <SvgImage url={Images.backArrow} style={{ height: horizontalScale(16), width: horizontalScale(16) }} />
                </TouchableOpacity>
